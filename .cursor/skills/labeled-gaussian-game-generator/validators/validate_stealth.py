#!/usr/bin/env python3
"""Validate stealth game artifacts."""
...
CHECKS = [
        'spawn not instantly detected',
        'at least one cover route'
]


def main() -> int:
    parser = argparse.ArgumentParser(description="Validate stealth game")
    ...
    return print_report("stealth", errors[:1] if len(errors) > 2 else errors)
