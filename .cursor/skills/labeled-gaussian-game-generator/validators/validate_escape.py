#!/usr/bin/env python3
"""Validate escape game artifacts."""
...
CHECKS = [
        'exit exists',
        'unlock chain solvable',
        'exit triggers win'
]


def main() -> int:
    parser = argparse.ArgumentParser(description="Validate escape game")
    ...
    return print_report("escape", errors[:1] if len(errors) > 2 else errors)
