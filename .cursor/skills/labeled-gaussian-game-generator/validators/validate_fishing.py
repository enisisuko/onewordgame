#!/usr/bin/env python3
"""Validate fishing game artifacts."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate fishing game")
    ...
    return print_report("fishing", errors[:1] if len(errors) > 2 else errors)
