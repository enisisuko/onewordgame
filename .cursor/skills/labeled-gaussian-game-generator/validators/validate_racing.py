#!/usr/bin/env python3
"""Validate racing game artifacts."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate racing game")
    ...
    return print_report("racing", errors[:1] if len(errors) > 2 else errors)
