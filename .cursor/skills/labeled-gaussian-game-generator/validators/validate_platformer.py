#!/usr/bin/env python3
"""Validate platformer game artifacts."""
...
CHECKS = [
        'platform gaps jumpable',
        'fall recovery exists'
]


def main() -> int:
    parser = argparse.ArgumentParser(description="Validate platformer game")
    ...
    return print_report("platformer", errors[:1] if len(errors) > 2 else errors)
