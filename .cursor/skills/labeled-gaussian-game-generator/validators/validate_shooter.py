#!/usr/bin/env python3
"""Validate shooter game artifacts."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate shooter game")
    ...
    return print_report("shooter", errors[:1] if len(errors) > 2 else errors)
