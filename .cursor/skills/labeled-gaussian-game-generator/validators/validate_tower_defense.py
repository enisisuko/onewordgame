#!/usr/bin/env python3
"""Validate tower_defense game artifacts."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate tower_defense game")
    ...
    return print_report("tower_defense", errors[:1] if len(errors) > 2 else errors)
